...
#######################################################################################################################
		...
		port = rospy.get_param("~port", "/dev/ttyACM002")
...
#Subscribers and Publishers
		...
		self._Left_Encoder = rospy.Publisher('lwheel',Int64,queue_size = 20)		
		self._Right_Encoder = rospy.Publisher('rwheel',Int64,queue_size = 20)		
...
#######################################################################################################################
#Speed subscriber
		self._left_motor_speed = rospy.Subscriber('left_wheel_control',Float32,self._Update_Left_Speed)

		self._right_motor_speed = rospy.Subscriber('right_wheel_control',Float32,self._Update_Right_Speed)
